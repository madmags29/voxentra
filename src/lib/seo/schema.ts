export function generateOrganizationSchema() {
  return {
    ...
    "description": "Voxentra Solutions is a top-tier US B2B customer acquisition agency specializing in 100% TCPA-compliant inbound pay-per-call marketing, performance telemarketing, and exclusive lead generation across all 50 states.",
    "telephone": "+91-8840682135",
    "email": "hello@voxentraglobal.com",
    "knowsAbout": [
      "100% TCPA Inbound Call Solutions",
      ...
      "Auto Insurance Rate Quote Leads",
